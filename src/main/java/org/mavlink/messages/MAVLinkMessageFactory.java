...
import org.mavlink.messages.common.msg_safety_set_allowed_area;
import org.mavlink.messages.common.msg_local_position_ned;
import org.mavlink.messages.common.msg_attitude;
import org.mavlink.messages.common.msg_battery_status;
import org.mavlink.messages.common.msg_mission_request;
import org.mavlink.messages.common.msg_heartbeat;
import org.mavlink.messages.common.msg_nav_controller_output;
import org.mavlink.messages.common.msg_setpoint_8dof;
import org.mavlink.messages.common.msg_gps_inject_data;
import org.mavlink.messages.common.msg_param_set;
import org.mavlink.messages.common.msg_file_transfer_dir_list;
import org.mavlink.messages.common.msg_log_request_list;
import org.mavlink.messages.common.msg_set_quad_swarm_led_roll_pitch_yaw_thrust;
import org.mavlink.messages.common.msg_highres_imu;
import org.mavlink.messages.common.msg_scaled_imu;
import org.mavlink.messages.common.msg_rc_channels_raw;
import org.mavlink.messages.common.msg_radio_status;
import org.mavlink.messages.common.msg_log_erase;
import org.mavlink.messages.common.msg_param_request_list;
import org.mavlink.messages.common.msg_change_operator_control_ack;
import org.mavlink.messages.common.msg_param_value;
import org.mavlink.messages.common.msg_hil_controls;
import org.mavlink.messages.common.msg_local_position_ned_system_global_offset;
import org.mavlink.messages.common.msg_gps_raw_int;
import org.mavlink.messages.common.msg_set_quad_motors_setpoint;
import org.mavlink.messages.common.msg_servo_output_raw;
import org.mavlink.messages.common.msg_scaled_pressure;
import org.mavlink.messages.common.msg_manual_setpoint;
import org.mavlink.messages.common.msg_debug_vect;
import org.mavlink.messages.common.msg_change_operator_control;
import org.mavlink.messages.common.msg_mission_write_partial_list;
import org.mavlink.messages.common.msg_safety_allowed_area;
import org.mavlink.messages.common.msg_gps_global_origin;
import org.mavlink.messages.common.msg_raw_pressure;
import org.mavlink.messages.common.msg_log_data;
import org.mavlink.messages.common.msg_set_mode;
import org.mavlink.messages.common.msg_mission_item_reached;
import org.mavlink.messages.common.msg_ping;
import org.mavlink.messages.common.msg_rc_channels_scaled;
import org.mavlink.messages.common.msg_rc_channels_override;
import org.mavlink.messages.common.msg_file_transfer_res;
import org.mavlink.messages.common.msg_mission_request_list;
import org.mavlink.messages.common.msg_file_transfer_start;
import org.mavlink.messages.common.msg_mission_set_current;
import org.mavlink.messages.common.msg_raw_imu;
import org.mavlink.messages.common.msg_sim_state;
import org.mavlink.messages.common.msg_named_value_int;
import org.mavlink.messages.common.msg_state_correction;
import org.mavlink.messages.common.msg_global_vision_position_estimate;
import org.mavlink.messages.common.msg_log_request_data;
import org.mavlink.messages.common.msg_optical_flow;
import org.mavlink.messages.common.msg_log_entry;
import org.mavlink.messages.common.msg_omnidirectional_flow;
import org.mavlink.messages.common.msg_scaled_imu2;
import org.mavlink.messages.common.msg_mission_request_partial_list;
import org.mavlink.messages.common.msg_command_long;
import org.mavlink.messages.common.msg_manual_control;
import org.mavlink.messages.common.msg_global_position_int;
import org.mavlink.messages.common.msg_mission_ack;
import org.mavlink.messages.common.msg_debug;
import org.mavlink.messages.common.msg_log_request_end;
import org.mavlink.messages.common.msg_param_request_read;
import org.mavlink.messages.common.msg_attitude_quaternion;
import org.mavlink.messages.common.msg_setpoint_6dof;
import org.mavlink.messages.common.msg_global_position_setpoint_int;
import org.mavlink.messages.common.msg_hil_rc_inputs_raw;
import org.mavlink.messages.common.msg_set_global_position_setpoint_int;
import org.mavlink.messages.common.msg_mission_clear_all;
import org.mavlink.messages.common.msg_roll_pitch_yaw_speed_thrust_setpoint;
import org.mavlink.messages.common.msg_mission_item;
import org.mavlink.messages.common.msg_named_value_float;
import org.mavlink.messages.common.msg_local_position_setpoint;
import org.mavlink.messages.common.msg_gps2_raw;
import org.mavlink.messages.common.msg_set_gps_global_origin;
import org.mavlink.messages.common.msg_roll_pitch_yaw_rates_thrust_setpoint;
import org.mavlink.messages.common.msg_set_roll_pitch_yaw_speed_thrust;
import org.mavlink.messages.common.msg_vision_speed_estimate;
...
import org.mavlink.messages.common.msg_vision_position_estimate;
import org.mavlink.messages.common.msg_system_time;
import org.mavlink.messages.common.msg_hil_state_quaternion;
import org.mavlink.messages.common.msg_hil_optical_flow;
import org.mavlink.messages.common.msg_mission_current;
import org.mavlink.messages.common.msg_set_roll_pitch_yaw_thrust;
import org.mavlink.messages.common.msg_mission_count;
import org.mavlink.messages.common.msg_set_local_position_setpoint;
import org.mavlink.messages.common.msg_hil_state;
import org.mavlink.messages.common.msg_gps_status;
import org.mavlink.messages.common.msg_data_stream;
import org.mavlink.messages.common.msg_command_ack;
import org.mavlink.messages.common.msg_set_quad_swarm_roll_pitch_yaw_thrust;
import org.mavlink.messages.common.msg_auth_key;
import org.mavlink.messages.common.msg_memory_vect;
import org.mavlink.messages.common.msg_roll_pitch_yaw_thrust_setpoint;
import org.mavlink.messages.common.msg_request_data_stream;
import org.mavlink.messages.common.msg_vicon_position_estimate;
/**
